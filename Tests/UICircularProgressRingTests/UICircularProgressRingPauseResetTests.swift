...
/**
 A seperate test case just for the completion block, since it's a timing based test it,
 does not work will with the other regular tests.
 
 It does require the use of usleep (or a different sleep method) to ensure that the pauseProgress
 actually has any effect and isn't premeturely firing it's completion block.
 */
